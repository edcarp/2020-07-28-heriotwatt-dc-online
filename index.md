...
venue: "Heriot Watt University (online)"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Jul 28-29, Aug 04-05 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Evgenij Belikov", "Mario Antonioletti", "Robert Nagy"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["(see above)"]     # boxed, comma-separate"Robert Nagy"d list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
